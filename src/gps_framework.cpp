    ...
    if(m_etat == Etat_OK){
        if(m_line){
            ...
            if(m_pilot_algo == AlgoPilot::FollowCarrot){
                ...
                m_angle_correction = m_curveAB.calculRearWheelPosition(essieu_arriere_x, essieu_arriere_y, m_tracteur.m_x_antenne, m_tracteur.m_y_antenne, m_deplacementX, m_deplacementY, m_vitesse, 1.5, m_pilot_rwp_kth, m_pilot_rwp_kte);
            } else {
                m_angle_correction = 0;
            }
        }
